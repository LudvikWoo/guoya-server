...
public class Response implements java.io.Serializable {
    ...
    public Response() {
        super();
    } //-- com.guoyasoft.bean.api.test.updateCustomer.response.Response()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.test.updateCustomer.response.Response unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.test.updateCustomer.response.Response) Unmarshaller.unmarshal(com.guoyasoft.bean.api.test.updateCustomer.response.Response.class, reader);
    } //-- com.guoyasoft.bean.api.test.updateCustomer.response.Response unmarshal(java.io.Reader) 
