...
public class CustomerChoice implements java.io.Serializable {
    ...
    } //-- com.guoyasoft.bean.api.test.updateCustomer.request.CustomerChoice()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.test.updateCustomer.request.CustomerChoice unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.test.updateCustomer.request.CustomerChoice) Unmarshaller.unmarshal(com.guoyasoft.bean.api.test.updateCustomer.request.CustomerChoice.class, reader);
    } //-- com.guoyasoft.bean.api.test.updateCustomer.request.CustomerChoice unmarshal(java.io.Reader) 
